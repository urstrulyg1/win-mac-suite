    ...
    return [
      {
        ...
        inspect: {
          ...
          subtitle: `Kernel architecture ${isMac ? 'Darwin (Mach-O)' : 'NT'} running on ${sys.hostName || 'UNAVAILABLE'}.`,
      ...
      },
      {
        ...
        sublabel: sys.processor || 'UNAVAILABLE',
        ...
        inspect: {
          ...
          subtitle: sys.processor || 'UNAVAILABLE',
      ...
      },
      {
        ...
        inspect: {
          ...
          subtitle: `Mounted root filesystem ${disk.volumeName || 'UNAVAILABLE'} .`,
      ...
      },
      {
        ...
        label: 'Power',
        title: 'Power & Thermal',
        sublabel: batt.powerSource || 'UNAVAILABLE',
