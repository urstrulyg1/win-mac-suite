  ...
  return (
    <div className="card p-5 sm:p-6">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-base font-bold" style={{ color: 'var(--color-ink)' }}>Maintenance Profile</h3>
          <p className="text-xs font-medium mt-0.5" style={{ color: 'var(--color-ink-4)' }}>Choose how aggressively the suite runs</p>
        </div>
