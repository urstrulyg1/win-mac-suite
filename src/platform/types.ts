...
export interface PlatformCapabilities {
  // Package Managers
  winget?: CapabilityStatus;
  chocolatey?: CapabilityStatus;
  scoop?: CapabilityStatus;
  homebrew?: CapabilityStatus;
  macports?: CapabilityStatus;
  mas?: CapabilityStatus;
  pip?: CapabilityStatus;
  npm?: CapabilityStatus;

  // System & Diagnostics Commands
  powershell?: CapabilityStatus;
  getWinEvent?: CapabilityStatus;
  getService?: CapabilityStatus;
  getPnpDevice?: CapabilityStatus;
  sfc?: CapabilityStatus;
  dism?: CapabilityStatus;
  storageSense?: CapabilityStatus;
  systemRestore?: CapabilityStatus;

  softwareupdate?: CapabilityStatus;
  diskutil?: CapabilityStatus;
  launchctl?: CapabilityStatus;
  tmutil?: CapabilityStatus;
  systemProfiler?: CapabilityStatus;
  mdutil?: CapabilityStatus;
  xcode?: CapabilityStatus;
  cocoapods?: CapabilityStatus;
  gatekeeper?: CapabilityStatus;
  xprotect?: CapabilityStatus;
  sip?: CapabilityStatus;
  fileVault?: CapabilityStatus;
...
export interface PlatformConfig {
  ...
  securityEngineName: string;
  integrityToolName: string;
  systemUpdateName: string;
  storeName: string;
  storageOptimizationName: string;
  quickActions: QuickAction[];
  phases: MaintenancePhaseTemplate[];
